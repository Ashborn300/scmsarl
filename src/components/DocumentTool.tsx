...
export const configs: Config[] = [
  ...
  { type: "version_nuit", titre: "Version Nuit", theme: "night-version", description: "Transformation Nano Banana d’une image de maison ou rendu 3D en version nuit ultra-réaliste, avec lampes intérieures et extérieures.", showTotal: false, fields: [
