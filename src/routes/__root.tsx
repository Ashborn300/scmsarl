...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Application professionnelle en français pour générer factures, devis, reçus, contrats et descriptions de projets SCM SARL." },
      { name: "author", content: "SCM SARL" },
      { property: "og:title", content: "SCM SARL — Gestion de documents BTP" },
      { property: "og:description", content: "Générez et archivez des PDF professionnels pour une entreprise de construction." },
